...
<body>
    <section class="container-fluid" id="tela-inicial">
        ...
        <article class="botoes d-flex justify-content-around">
            <button type="button" href="" id="btn-criar" class="btn btn-primary">Crie uma conta</button>
            <button type="button" href="" id="btn-login"class="btn btn-primary">Faça login</button>
        </article>
    </section>
